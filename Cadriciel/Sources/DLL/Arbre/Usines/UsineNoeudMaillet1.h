...
/// @date 2016-09-30
///////////////////////////////////////////////////////////////////////////
class UsineNoeudMaillet1 : public UsineAbstraite
{
public:
	///Constructeur par paramètres
	inline UsineNoeudMaillet1(const std::string& nom);
...
inline UsineNoeudMaillet1::UsineNoeudMaillet1(const std::string& nom)
	:UsineAbstraite(nom)
{
...
NoeudAbstrait* UsineNoeudMaillet1::creerNoeud() const
{
	auto noeud = new NoeudMaillet{ obtenirNom() };
	noeud->assignerObjetRendu(&modele_, &vbo_);
	return noeud;
}

NoeudAbstrait* UsineNoeudMaillet1::creerNoeud(tinyxml2::XMLNode * node)const
{
