...
/// @date 2016-09-30
///////////////////////////////////////////////////////////////////////////
class UsineNoeudRondelle : public UsineAbstraite
{
public:
...
{
	auto noeud = new NoeudRondelle{ obtenirNom() };
	noeud->assignerObjetRendu(&modele_, &vbo_);
	return noeud;
}

NoeudAbstrait* UsineNoeudRondelle::creerNoeud(tinyxml2::XMLNode * node)const
{
	NoeudRondelle* noeud = new NoeudRondelle(obtenirNom());
	...
	node->ToElement()->QueryDoubleAttribute("RAYON_RONDELLE", &rayon);
	...
	noeud->modifierRayonRondelle(rayon);
