...
/// @date 2016-09-30
///////////////////////////////////////////////////////////////////////////
class UsineNoeudMaillet2 : public UsineAbstraite
{
public:
	///Constructeur par paramètres
	inline UsineNoeudMaillet2(const std::string& nom);
...
inline UsineNoeudMaillet2::UsineNoeudMaillet2(const std::string& nom)
	:UsineAbstraite(nom)
{
...
NoeudAbstrait* UsineNoeudMaillet2::creerNoeud() const
{
...
NoeudAbstrait* UsineNoeudMaillet2::creerNoeud(tinyxml2::XMLNode * node)const
{
