...
/// Force à ne pas inclure les macros min et max de windows.h
#define NOMINMAX
...
namespace utilitaire {
	...
	////////////////////////////////////////////////////////////////////////
	///
	/// Fonction permettant de vérifier si deux points sont du même bord d'un vecteur
	///
	/// Fonction qui vérifie si deux points sont du même bord d'un vecteur
	///
	/// @param [in] point1 : point à vérifier
	/// @param [in] point2 : point à vérifier
	/// @param [in] point1Vecteur : Premier point du vecteur
	/// @param [in] point2Vecteur : Deuxième point du vecteur
	///
	/// @return Vrai si les points sont du même bord du vecteur
	///
	//////////////////////////////////////////////////////////////////////// 
	...
	////////////////////////////////////////////////////////////////////////
	///
	/// Fonction prenant des vecteurs de 3dimensions permettant de vérifier si deux points sont du même bord d'un vecteur
	///
	/// Fonction qui vérifie si deux points sont du même bord d'un vecteur
	///
	/// @param [in] point1 : point à vérifier
