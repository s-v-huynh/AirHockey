...
namespace utilitaire {
	...
	/// Fonction prenant des vecteurs de 3dimensions permettant de vérifier si les sommets d'un point est contenu dans un polygone2D
	bool pointsDansPolygone2D(const glm::dvec3& point, const std::vector<glm::dvec3>& polygone);
	/// Fonction prenant des vecteurs de 3dimensions permettant de vérifier si les sommets d'un objet sont contenu dans un polygone2D
