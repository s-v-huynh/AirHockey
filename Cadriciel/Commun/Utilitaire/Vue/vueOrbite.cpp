...
namespace vue {
	...
	///
	////////////////////////////////////////////////////////////////////////
	void VueOrbite::deplacerXY(double deplacementX, double deplacementY, int x, int y)
	{
		camera_.deplacerXY(deplacementX ,
			deplacementY ,x,y);
	}
	...
	///
	////////////////////////////////////////////////////////////////////////
	void VueOrbite::deplacerXY(const glm::ivec2& deplacement, int x, int y)
	{
	...
	void VueOrbite::definirProjection() const
	{
		projection_.actualisationProjection();
	}
	...
	void VueOrbite::deplacerClavier(double x, double y)
	{
		camera_.orbiterXY(x, y, true);
	}

	void VueOrbite::deplacerClavierBas(double x, double y)
	{
		camera_.orbiterXY(0.0,-5.0, true);
	}

	void VueOrbite::deplacerClavierDroite(double x, double y)
	{
		camera_.orbiterXY(-5.0, 0.0, true);
	}

	void VueOrbite::deplacerClavierGauche(double x, double y)
	{
		camera_.orbiterXY(5.0, 0.0, true);
	}

	void VueOrbite::deplacerSouris(glm::dvec3 dSouris)
	{
		camera_.assignerPosition(camera_.obtenirPosition() - std::move(dSouris));
		camera_.assignerPointVise(camera_.obtenirPointVise() - std::move(dSouris));
	}
